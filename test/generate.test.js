...
describe('unit: generator', () => {
  it('generate', () => {
    ...
    expect(generate({ words: 2 })).to.match(/^[a-z]*-[a-z]*-[0-9]{4}$/)
    expect(generate({ words: 3 })).to.match(/^[a-z]*-[a-z]*-[a-z]*-[0-9]{4}$/)
    expect(generate({ words: 4 })).to.match(/^[a-z]*-[a-z]*-[a-z]*-[a-z]*-[0-9]{4}$/)
